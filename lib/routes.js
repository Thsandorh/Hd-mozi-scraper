    ...
    <body>
        <div class="container">
            <section class="hero">
                ...
                <div class="actions">
                    <a class="btn btn-primary" id="install-btn" href="#" rel="noopener">🚀 1‑kattintás Stremio telepítés</a>
                ...
                <div class="manifest-box">
                    ...
                    <code id="manifest-url">${req.protocol}://${req.get('host')}/manifest.json</code>
            ...
            <section class="grid">
                ...
                <div class="card">
                    ...
                    <div class="actions">
                        <a class="btn btn-primary" id="install-btn-2" href="#" rel="noopener">➕ Addon telepítés</a>
                        <button class="btn btn-outline" id="copy-btn-2" type="button">📎 Manifest másolása</button>
                    </div>
                    <p style="margin-top: 12px; color: var(--muted);">
                        Ha a gomb nem nyitná meg az asztali Stremio appot, használd a webes telepítést.
                    </p>
                    <a class="btn btn-outline" id="install-web-btn" href="#" target="_blank" rel="noopener">🌐 Webes Stremio telepítés</a>
                </div>
            </section>
        ...
        <script>
            ...
            const stremioInstallUrl = 'stremio://addon-install?url=' + encodeURIComponent(manifestUrl);
            const stremioWebInstallUrl = 'https://stremio.com/addon-install?addon=' + encodeURIComponent(manifestUrl);

            const installButtons = [document.getElementById('install-btn'), document.getElementById('install-btn-2')];
            installButtons.forEach((button) => {
                if (!button) return;
                button.setAttribute('href', stremioInstallUrl);
            ...
            const webInstallButton = document.getElementById('install-web-btn');
            if (webInstallButton) {
                webInstallButton.setAttribute('href', stremioWebInstallUrl);
            }
